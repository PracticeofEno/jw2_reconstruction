#!/usr/bin/env python3
"""Compare selector-0x0d area-marker commands with the original."""
...
def main() -> int:
    ...
    manifest = json.loads((tool_dir / "area_toggle_batch_manifest.json")
